    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("10000000-0000-0000-0000-000000000001"), "", "", "", null, false, false });

            migrationBuilder.InsertData(
                table: "Warehouses",
                columns: new[] { "Id", "IsActive", "Location", "Name" },
                values: new object[] { new Guid("20000000-0000-0000-0000-000000000001"), true, null, "انبار اصلی" });

            migrationBuilder.CreateIndex(
                name: "IX_AppUsers_TelegramId",
                table: "AppUsers",
                column: "TelegramId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GlobalDiscountTiers_IsActive",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductDiscountTiers_ProductId_IsActive",
                table: "ProductDiscountTiers",
